...
#define nrn_init _nrn_init__NMDA_KIN2
#define _nrn_initial _nrn_initial__NMDA_KIN2
#define nrn_cur _nrn_cur__NMDA_KIN2
#define _nrn_current _nrn_current__NMDA_KIN2
#define nrn_jacob _nrn_jacob__NMDA_KIN2
#define nrn_state _nrn_state__NMDA_KIN2
#define _net_receive _net_receive__NMDA_KIN2 
#define kstates kstates__NMDA_KIN2 
#define mgblock mgblock__NMDA_KIN2 
...
#define sh _p[12]
#define sh_columnindex 12
#define gmax _p[13]
#define gmax_columnindex 13
#define kin_slope _p[14]
#define kin_slope_columnindex 14
#define kin_offset _p[15]
#define kin_offset_columnindex 15
#define i _p[16]
...
#define Ru _p[19]
#define Ru_columnindex 19
#define Rb _p[20]
#define Rb_columnindex 20
#define Rc _p[21]
#define Rc_columnindex 21
#define Ro _p[22]
#define Ro_columnindex 22
#define C _p[23]
#define C_columnindex 23
#define kin_factor _p[24]
#define kin_factor_columnindex 24
#define scale _p[25]
#define scale_columnindex 25
#define DRu _p[26]
#define DRu_columnindex 26
#define DRb _p[27]
#define DRb_columnindex 27
#define DRc _p[28]
#define DRc_columnindex 28
#define DRo _p[29]
#define DRo_columnindex 29
#define v _p[30]
#define v_columnindex 30
#define _g _p[31]
#define _g_columnindex 31
#define _tsav _p[32]
#define _tsav_columnindex 32
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_KIN2 /Users/sandek/CA1Sim/nmda_kin2.mod\n");
...
static int  mgblock ( _threadargsprotocomma_ double _lv ) {
   B = 1. / ( 1. + exp ( gamma * ( - _lv + sh ) ) * ( mg / Kd ) ) ;
   if ( _lv <= - 70.0 ) {
     kin_factor = kin_slope * ( - 70.0 ) + kin_offset ;
     }
   else {
     if ( _lv >= 40.0 ) {
       kin_factor = 1.0 ;
       ...
       kin_factor = kin_slope * ( _lv ) + kin_offset ;
       }
     }
    return 0; }
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = Ro_columnindex;  _dlist1[0] = DRo_columnindex;
 _slist1[1] = Rc_columnindex;  _dlist1[1] = DRc_columnindex;
 _slist1[2] = Rb_columnindex;  _dlist1[2] = DRb_columnindex;
 _slist1[3] = Ru_columnindex;  _dlist1[3] = DRu_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/nmda_kin2.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "\n"
