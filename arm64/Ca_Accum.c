...
#define taucadiv _p[1]
#define taucadiv_columnindex 1
#define depth _p[2]
#define depth_columnindex 2
#define cai0 _p[3]
#define cai0_columnindex 3
#define eca _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Cacum /Users/sandek/CA1Sim/Ca_Accum.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   Dcai = - ( 1e7 ) * ica / 2. / F / depth - taucadiv * ( cai - cai0 ) / tau ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
 Dcai = Dcai  / (1. - dt*( ( - ( ( taucadiv )*( ( 1.0 ) ) ) / tau ) )) ;
  return 0;
}
 /*END CVODE*/
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/Ca_Accum.mod";
static const char* nmodl_file_text = 
