...
#define nrn_init _nrn_init__NMDA_KIN3
#define _nrn_initial _nrn_initial__NMDA_KIN3
#define nrn_cur _nrn_cur__NMDA_KIN3
#define _nrn_current _nrn_current__NMDA_KIN3
#define nrn_jacob _nrn_jacob__NMDA_KIN3
#define nrn_state _nrn_state__NMDA_KIN3
#define _net_receive _net_receive__NMDA_KIN3 
#define kstates kstates__NMDA_KIN3 
#define mgblock mgblock__NMDA_KIN3 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_KIN3 /Users/sandek/CA1Sim/nmda_kin3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/nmda_kin3.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "\n"
