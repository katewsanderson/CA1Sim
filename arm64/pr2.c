...
#define nrn_init _nrn_init__Pr2
#define _nrn_initial _nrn_initial__Pr2
#define nrn_cur _nrn_cur__Pr2
#define _nrn_current _nrn_current__Pr2
#define nrn_jacob _nrn_jacob__Pr2
#define nrn_state _nrn_state__Pr2
#define _net_receive _net_receive__Pr2 
#define setRandObjRef setRandObjRef__Pr2 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Pr2 /Users/sandek/CA1Sim/pr2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/pr2.mod";
static const char* nmodl_file_text = 
  ...
  "    f = 1.681           (1)     < 0, 1e9 >      : additive facilitation per spike\n"
  "    tau_F = 70.735      (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following facilitation\n"
  "    d1 = 0.901          (1)     < 0, 1 >        : multiplicative fast depression per spike\n"
  "    tau_D1 = 134.862    (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following fast depression\n"
