...
#define nrn_init _nrn_init__AMPA_KIN
#define _nrn_initial _nrn_initial__AMPA_KIN
#define nrn_cur _nrn_cur__AMPA_KIN
#define _nrn_current _nrn_current__AMPA_KIN
#define nrn_jacob _nrn_jacob__AMPA_KIN
#define nrn_state _nrn_state__AMPA_KIN
#define _net_receive _net_receive__AMPA_KIN 
#define kstates kstates__AMPA_KIN 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 AMPA_KIN /Users/sandek/CA1Sim/ampa_kin.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/ampa_kin.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "\n"
