...
#define nrn_init _nrn_init__km3
#define _nrn_initial _nrn_initial__km3
#define nrn_cur _nrn_cur__km3
#define _nrn_current _nrn_current__km3
#define nrn_jacob _nrn_jacob__km3
#define nrn_state _nrn_state__km3
#define _net_receive _net_receive__km3 
#define rate rate__km3 
#define state state__km3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_km3", _hoc_setdata,
 "alpt_km3", _hoc_alpt,
 "bett_km3", _hoc_bett,
 "rate_km3", _hoc_rate,
 0, 0
};
#define alpt alpt_km3
#define bett bett_km3
...
#define t0 t0_km3
 double t0 = 15;
#define vhalft vhalft_km3
 double vhalft = -42;
#define vhalfl vhalfl_km3
 double vhalfl = -42;
#define zetat zetat_km3
 double zetat = 7;
 ...
 "vhalfl_km3", &vhalfl_km3,
 "kl_km3", &kl_km3,
 "vhalft_km3", &vhalft_km3,
 "a0t_km3", &a0t_km3,
 "zetat_km3", &zetat_km3,
 "gmt_km3", &gmt_km3,
 "q10_km3", &q10_km3,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km3 /Users/sandek/CA1Sim/km3.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 35.0 ) / 10.0 ) ) ;
   ...
   tau = t0 + bett ( _threadargscomma_ _lv ) / ( a0t * ( 1.0 + _la ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/km3.mod";
static const char* nmodl_file_text = 
