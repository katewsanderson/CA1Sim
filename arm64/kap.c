...
#define linf _p[5]
#define linf_columnindex 5
#define taul _p[6]
#define taul_columnindex 6
#define taun _p[7]
#define taun_columnindex 7
#define gka _p[8]
#define gka_columnindex 8
#define n _p[9]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kap /Users/sandek/CA1Sim/kap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/kap.mod";
static const char* nmodl_file_text = 
