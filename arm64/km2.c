...
#define nrn_init _nrn_init__km2
#define _nrn_initial _nrn_initial__km2
#define nrn_cur _nrn_cur__km2
#define _nrn_current _nrn_current__km2
#define nrn_jacob _nrn_jacob__km2
#define nrn_state _nrn_state__km2
#define _net_receive _net_receive__km2 
#define rate rate__km2 
#define state state__km2 
...
#define tau_f _p[8]
#define tau_f_columnindex 8
#define tau_s _p[9]
#define tau_s_columnindex 9
#define v _p[10]
...
#define st st_km2
 double st = 1;
#define t0_s t0_s_km2
 double t0_s = 60;
#define t0_f t0_f_km2
 double t0_f = 15;
#define vhalft vhalft_km2
 double vhalft = -42;
#define vhalfl vhalfl_km2
 double vhalfl = -40;
#define zetat zetat_km2
 double zetat = 7;
 ...
 "vhalfl_km2", &vhalfl_km2,
 "kl_km2", &kl_km2,
 "vhalft_km2", &vhalft_km2,
 "a0t_f_km2", &a0t_f_km2,
 "a0t_s_km2", &a0t_s_km2,
 "zetat_km2", &zetat_km2,
 "gmt_km2", &gmt_km2,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km2 /Users/sandek/CA1Sim/km2.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 35.0 ) / 10.0 ) ) ;
   ...
   tau_f = t0_f + bett ( _threadargscomma_ _lv ) / ( a0t_f * ( 1.0 + _la ) ) ;
   tau_s = t0_s + bett ( _threadargscomma_ _lv ) / ( a0t_s * ( 1.0 + _la ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/sandek/CA1Sim/km2.mod";
static const char* nmodl_file_text = 
