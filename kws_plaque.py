...
def plaque_prune(branch, target_third, fraction=0.5, rand=None):

    # how to delete a fraction of spines from a specific third of a branch.
    ...
    if total_spines < 3:
        print(f"Branch {branch.sec.name()} unable to split into thirds.")
        return []
